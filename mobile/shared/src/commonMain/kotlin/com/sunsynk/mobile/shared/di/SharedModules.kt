...
val sharedModule: Module = module {
    ...
    single {
        val apiClient: com.sunsynk.mobile.shared.network.SunsynkApiClient = get()
        val cache: DashboardCache? = runCatching { get<DashboardCache>() }.getOrNull()
        SunsynkRepository(apiClient = apiClient, dashboardCache = cache)
    }
}
